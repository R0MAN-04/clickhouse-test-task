...
| B. Leverkusen | 145                 |
```
### 2) Кількість гравців, які підписали контракт із клубом після нього (у розрізі клубу та гравця)
```sql
SELECT
    bp1.club
    , bp1.name
...
### 7) Позиція, де найважче отримати контракт з будь-якою компанією 
...
### 8) Команда, у якої найперше закінчиться контракт у 5 гравців
```sql
SELECT
    club
...
### 9) Вік гравців, які здебільшого виходять на пік своєї вартості
```sql
SELECT
    age
